...
//           'name': 'Self',
//           'admin': user.uid,
//           'passwordHash': '', // No password for "Self" gathering
//           'isSelf': true, // Flag to identify "Self" gathering
//         });
...
//         // Initialize items subcollection
//         await teamRef.collection('items').doc().set({
//           'name': 'Default Item',
//           'quantity': 0,
